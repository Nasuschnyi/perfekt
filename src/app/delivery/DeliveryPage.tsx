			...
			<ul className={style.list}>
				...
				<li className={`${style.item} ${style.itemLast}`}>
					<span>
						...
						службі доставки та зв&apos;язатися з нашим менеджером. У
						разі виникнення питань, пов&apos;язаних з доставкою або
						оплатою, зв&apos;яжіться з нашим менеджером.
					</span>
				</li>
			</ul>
			...
			<ul className={style.list}>
				...
				<li className={style.item}>
					<span className={style.text}>
						...
						вантажоперевізника (комісія &quot;Нова пошта&quot; - 20
						грн + 3% від вартості товару).
					</span>
				</li>
				<li className={style.item}>
					<span className={style.text}>
				...
				<li className={`${style.item} ${style.itemLast}`}>
					<span>
						...
						замовлення, необхідно зв&apos;язатися з менеджером
